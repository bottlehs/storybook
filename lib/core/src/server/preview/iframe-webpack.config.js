  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        'semver/internal/re.js': require.resolve('@storybook/semver/internal/re.js'),
        'semver/internal/constants.js': require.resolve('@storybook/semver/internal/constants.js'),
        'semver/internal/identifiers.js': require.resolve(
          '@storybook/semver/internal/identifiers.js'
        ),
        ...reactPaths,
      },
